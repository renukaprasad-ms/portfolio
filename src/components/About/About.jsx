  ...
  const highlights = [
    {
      ...
      description: "Building scalable full-stack and backend applications",
    },
    {
      icon: <FaServer />,
    ...
    },
    {
      ...
      title: "B.Sc Graduate",
      description: "GMS Academy • Computer Science",
    },
    {
      icon: <FaMapMarkerAlt />,
      title: "Based in",
      description: "Davanagere, India",
    },
  ];
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-neutral-100 mb-2">
                Hi, I'm{" "}
                <span className="text-amber-400">Renuka Prasad M S</span>
              </h3>
