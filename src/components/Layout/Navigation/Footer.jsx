  ...
  const socialLinks = [
    {
      name: "GitHub",
      icon: FaGithub,
      url: "https://github.com/renukaprasad-ms",
    },
    {
      name: "LinkedIn",
      icon: FaLinkedin,
      url: "https://www.linkedin.com/in/renuka-prasad-m-s/",
    },
    {
      name: "Email",
      icon: FaEnvelope,
      url: "mailto:renukaprasadms00@gmail.com",
    },
  ];
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2 text-sm text-neutral-500">
            <span className="flex items-center gap-1.5">
              ...
              by <span className="text-neutral-400">Renuka Prasad M S</span>
            </span>
